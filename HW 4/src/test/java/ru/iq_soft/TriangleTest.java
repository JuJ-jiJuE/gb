...
public class TriangleTest{
    ...
    @Test
    @DisplayName("проверка сходимости формулы на существующем треугольнике")
    void test1() throws InvalidTriangleException, DegenerateTriangleException {
        logger.info(":проверка сходимости формулы на существующем треугольнике");
    ...
    @DisplayName(" проверка корректности вычисления площади на существующих треугольниках")
    void test2(int a, int b, int c, double d) throws InvalidTriangleException, DegenerateTriangleException {
        logger.info(" проверка корректности вычисления площади на существующих треугольниках");
    ...
    @DisplayName(" проверка корректности срабатывания исключнения при вырождении в точку или отрезок")
    void test3(int a, int b, int c) throws InvalidTriangleException, DegenerateTriangleException {
        logger.info(" проверка корректности срабатывания исключнения при вырождении в точку или отрезок");
    ...
    @Test
    @DisplayName("проверка корректности срабатывания исключения, когда треугольник не существует")
    void test4() throws InvalidTriangleException, DegenerateTriangleException {
        logger.info("проверка корректности срабатывания исключения, когда треугольник не существует");
