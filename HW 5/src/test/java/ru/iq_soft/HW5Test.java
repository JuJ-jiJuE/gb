...
public class HW5Test {
    ...
    public void testCase6() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='NAME']")).sendKeys("tttt");
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).sendKeys("testgb");
        ...
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='SECOND_NAME']")).sendKeys("gb");
        driver.findElement(By.xpath("//input[@name='LAST_NAME']")).clear();
        driver.findElement(By.xpath("//input[@name='LAST_NAME']")).sendKeys("4");
        driver.findElement(By.xpath("//input[@name='NEW_PASSWORD']")).clear();
        // сохранение
        js.executeScript("window.scrollTo(0, 700)");
        Thread.sleep(1000);
