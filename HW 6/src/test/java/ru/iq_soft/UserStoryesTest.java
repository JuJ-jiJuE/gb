...
public class UserStoryesTest extends AbstractTest{
    ...
    public void testCase6()  throws InterruptedException {
        ...
        new LoginPage(getWebDriver())
                ...
                .pressInBtt();
        assertTrue(new MainPage(getWebDriver()).checkUser("test"));
        ...
        new CabinetPage(getWebDriver())
                .pressPersonlBtt()
                .setNameField("tt")
                .setSecondNameField("tttt)
                .setLastNameField("ttt")
        ...
        assertTrue(new MainPage(getWebDriver()).checkUser("tester"));
        ...
        new CabinetPage(getWebDriver())
                ...
                .pressApplyBtt();
        getWebDriver().get("https://ribomaniya.ru/cabinet/personal/?"); // обновление страницы
        assertTrue(new MainPage(getWebDriver()).checkUser("gb1"));
